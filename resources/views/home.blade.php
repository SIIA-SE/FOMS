    ...
    <div class="card-body">
      <div class="d-inline-block mt-4 mr-2 card border-dark" style="width: 18rem;">
        <div class="card-body">
          ...
          <p class="card-text">Total: {{ count(Auth::user()->institutes()->get()) }} | Joined: {{ count(\App\Staff::where('user_id', Auth::user()->id)->get()) }} | Trashed: {{ count(Auth::user()->institutes()->onlyTrashed()->get()) }}</p>
          <div class="progress">
